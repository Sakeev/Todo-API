...
const ToDoContextProvider = ({children}) => {
    ...
    return <todoContext.Provider value={{todos: state.todos, taskToEdit: state.taskToEdit, addTask, getTodos, changeStatus, deleteTask, editTodo, saveTask}}>{children}</todoContext.Provider>
};
